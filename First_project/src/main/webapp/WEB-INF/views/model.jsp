			...
			<div class="navbar-collapse collapse justify-content-stretch" id="navbarNav">
				<ul class="nav navbar-nav">
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu dropdown-menu-right dark" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item bg-dark active" href="/admin/model">Model</a>
						</div>
				   </li>
				</ul>
			...
			<div class="col">
				<form:form action="/admin/model" method="POST" modelAttribute="model">
					...
					<div class="form-group row">
						<form:input path="name" class="form-control" placeholder="Add new model"/>
						<custom:hiddenInputs excludeParams="name"/>
							<button class="btn btn-success" type="submit">Save</button>
							<a href="/admin/model/cancel<custom:allParams/>" class="btn btn-warning" type="submit">Cancel</a>
					</div>
				</form:form>
			</div>
		</div>
					...
					<c:forEach var="model" items="${models.content}">
						<tr>
							...
							<td class="text-center">
								<a href="/admin/model/update/${model.id}" class="btn btn-warning btn-sm">Update</a> 
								<a href="/admin/model/delete/${model.id}" class="btn btn-danger btn-sm">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</table>
