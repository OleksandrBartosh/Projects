				...
				<ul class="nav navbar-nav">
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item bg-dark active" href="/admin/city">City</a>
			...
			<div class="col">
				<form:form action="/admin/city" method="POST" modelAttribute="city">
					...
					<div class="form-group row">
						<form:input path="name" class="form-control" placeholder="Add new city"/>
						<custom:hiddenInputs excludeParams="name"/>
							<button class="btn btn-success" type="submit">Save</button>
							<a href="/admin/city/cancel<custom:allParams/>" class="btn btn-warning" type="submit">Cancel</a>
					</div>
				</form:form>
			</div>
		</div>
