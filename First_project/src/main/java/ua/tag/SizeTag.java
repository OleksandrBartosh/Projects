...
public class SizeTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		sw.append("<button class='btn btn-outline-dark dropdown-toggle' type='button' data-toggle='dropdown'>");
		sw.append(title);
		sw.append("</button><div class='dropdown-menu dropdown-menu-right'>");
